...
const BLOUSE_FIELDS: MeasurementFieldDef[] = [
  { key: "shoulder", letter: "1" },
  { key: "armHole", letter: "2" },
  { key: "chest", letter: "3" },
  { key: "waist", letter: "4" },
  { key: "blouseLen", letter: "5" },
  { key: "armLength", letter: "6" },
  { key: "sleeve", letter: "7" },
  { key: "custom" },
];

/** 18-point dress / shirt chart (institute style) */
const DRESS_FIELDS: MeasurementFieldDef[] = [
  { key: "neck", letter: "1" },
  { key: "overBust", letter: "2" },
  { key: "bust", letter: "3" },
  { key: "underBust", letter: "4" },
  { key: "waist", letter: "5" },
  { key: "hip", letter: "6" },
  { key: "length", letter: "7" },
  { key: "neckToAboveKnee", letter: "8" },
  { key: "aboveKneeToAnkle", letter: "9" },
  { key: "armLength", letter: "10" },
  { key: "shoulder", letter: "11" },
  { key: "armHole", letter: "12" },
  { key: "bicep", letter: "13" },
  { key: "foreArm", letter: "14" },
  { key: "wrist", letter: "15" },
  { key: "frontNeck", letter: "16" },
  { key: "frontWaist", letter: "17" },
  { key: "trouserThreeQuarter", letter: "18" },
  { key: "custom" },
];
