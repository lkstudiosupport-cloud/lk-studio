...
export default async function DesignsShopPage({
  searchParams,
}: {
  ...
  if (!session?.shopId) redirect("/login/shop?app=designs");
  ...
  try {
    ...
    console.error("[lk-studio] designs shop page error:", err);
