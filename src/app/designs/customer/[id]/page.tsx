...
const LIST_PATH = "/designs/customer";

export default async function DesignsCustomerDetailPage({
  params,
  searchParams,
}: {
  ...
  const backHref = design.isCatalog
    ? categoryParam
      ? withQueryParam(LIST_PATH, "category", categoryParam as ServiceCategory)
      : withQueryParam(LIST_PATH, "category", design.category)
    : withQueryParam(LIST_PATH, "category", design.category);
