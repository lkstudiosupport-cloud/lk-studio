...
const bn = {
  ...
  billPresetPickHint: "নিচে ট্যাপ করে বিলে যোগ করুন, তারপর পরিমাণ ও দাম দিন।",
  billPresetQtyPriceHint: "প্রতিটি বেছে নেওয়া আইটেমের পরিমাণ ও দাম দিন। নাম বদলাতে মাইক ব্যবহার করুন।",
  billPresetGroup: {
  ...
  billPreset: {
    ...
    shapeBlouseLining: "শেপ ব্লাউজ লাইনিং",
    dress: "ড্রেস",
    top: "টপ",
